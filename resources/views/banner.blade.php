<div
    class="h-auto max-w-full py-2 mt-3 duration-300 ease-out bg-white rounded-lg shadow-sm dark:bg-gray-900 sm:py-0 sm:h-10">
    <div class="flex items-center justify-between w-full h-full px-3 mx-auto max-w-7xl ">
        <a href="https://github.com/Shipu/dinero" target="_blank"
            ...
            <span class="flex items-center">
                ...
                &nbsp;
                <x-filament::icon class="w-5 h-5" icon="lucide-mouse-pointer-click" />
            </span>
        </a>
    </div>
</div>
